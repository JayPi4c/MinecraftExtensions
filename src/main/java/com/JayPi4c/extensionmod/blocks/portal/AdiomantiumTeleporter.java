...
public class AdiomantiumTeleporter extends Teleporter {
	...
	public AdiomantiumTeleporter(WorldServer world) {
		super(world);
				...
				for (int i1 = -2; i1 <= 2; ++i1) {
					for (int j1 = -1; j1 < 3; ++j1) {
						...
						this.worldServerInstance.setBlock(k1, l1, i2,
								flag ? com.JayPi4c.extensionmod.blocks.Blocks.adiomantium_block : Blocks.air);
					}
				}
			}
	...
	public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_,
		...
		if (this.destinationCoordinateCache.containsItem(j1)) {
			AdiomantiumTeleporter.PortalPosition portalposition = (AdiomantiumTeleporter.PortalPosition) this.destinationCoordinateCache
					.getValueByKey(j1);
			d3 = 0.0D;
			...
			for (l3 = l - short1; l3 <= l + short1; ++l3) {
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
					...
					for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
						if (this.worldServerInstance.getBlock(l3, i2,
								l1) == com.JayPi4c.extensionmod.blocks.Blocks.adiomantium_portal_block) {
		...
		if (d3 >= 0.0D) {
			if (flag) {
				this.destinationCoordinateCache.add(j1, new AdiomantiumTeleporter.PortalPosition(i, j, k,
			...
			if (this.worldServerInstance.getBlock(i - 1, j,
					k) == com.JayPi4c.extensionmod.blocks.Blocks.adiomantium_portal_block) {
				i4 = 2;
			}
			...
			if (this.worldServerInstance.getBlock(i, j,
					k - 1) == com.JayPi4c.extensionmod.blocks.Blocks.adiomantium_portal_block) {
				i4 = 3;
			}
		...
		for (i3 = 0; i3 < 4; ++i3) {
			for (j3 = 0; j3 < 4; ++j3) {
				for (k3 = -1; k3 < 4; ++k3) {
					...
					this.worldServerInstance.setBlock(l3, i4, j4,
							flag ? com.JayPi4c.extensionmod.blocks.Blocks.adiomantium_block
									: com.JayPi4c.extensionmod.blocks.Blocks.adiomantium_portal_block,
							0, 2);
				}
			}
