...
public class AdiomantiumCraftingTableCraftingManager {
	/** The static instance of this class */
	private static final AdiomantiumCraftingTableCraftingManager instance = new AdiomantiumCraftingTableCraftingManager();
	 ...
	 */
	public static final AdiomantiumCraftingTableCraftingManager getInstance() {
		/** The static instance of this class */
		return instance;
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	private AdiomantiumCraftingTableCraftingManager() {
		recipes = new ArrayList();

		// wenn man die standard Minecraft Rezepte auch im Adiomantium Crafting Table
		// nutzen will, dann müssen die addRecipe Methoden aus dem Konstruktor der
		// net.minecraft.item.crafting.CraftingManager.class kopiert werden.
		this.addRecipe(new ItemStack(Blocks.stone), "#####", "#####", "#####", "#####", "#####", '#',
				new ItemStack(Blocks.cobblestone));

		Collections.sort(this.recipes, new AdiomantiumCraftingTableRecipeSorter(this));
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	public AdiomantiumCraftingTableShapedRecipes addRecipe(ItemStack output, Object... p_92103_2_) {
		String s = "";
		int i = 0;
		int j = 0;
		int k = 0;
		...
		AdiomantiumCraftingTableShapedRecipes shapedrecipes = new AdiomantiumCraftingTableShapedRecipes(j, k,
				aitemstack, output);
