...
public class AdiomantiumChunkProvider implements IChunkProvider {
	/** RNG. */
	private Random rand;
	...
	public AdiomantiumChunkProvider(World world, long p_i2006_2_, boolean p_i2006_4_) {
		this.worldObj = world;
					...
					for (int l2 = 0; l2 < 8; ++l2) {
						...
						for (int i3 = 0; i3 < 4; ++i3) {
							...
							for (int k3 = 0; k3 < 4; ++k3) {
								if ((d15 += d16) > 0.0D) {
									p_147424_3_[j3 += short1] = com.JayPi4c.extensionmod.blocks.Blocks.adiomantium_block;
								} else if (k2 * 8 + l2 < b0) {
	...
	public void replaceBlocksForBiome(int p_147422_1_, int p_147422_2_, Block[] p_147422_3_, byte[] p_147422_4_,
		...
		double d0 = 0.03125D;
		this.stoneNoise = this.field_147430_m.func_151599_a(this.stoneNoise, p_147422_1_ * 16, p_147422_2_ * 16, 16, 16,
